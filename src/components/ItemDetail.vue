...
export default {
  ...
  methods: {
    retrieveItem(id){
      TutorialDataService.getItemById(id)
        .then(response => {
          this.currentItem = response.data;
          this.title = this.currentItem[0].title;
          this.price = this.currentItem[0].price;
          this.description = this.currentItem[0].description;
          console.log(this.currentItem[0].title);
        })
        .catch(e => {
          console.log(e);
        })
    ...
    addToBag(e){
      ...
      if(this.currentUser){
        ...
        cartService.addItemToCart(this.currentItem[0].id, this.currentItem[0].price, this.currentItem[0].title, this.currentUser.id);
      } else{
      ...
      <div class="pt-6">
        <nav aria-label="Breadcrumb">
          <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <li class="text-sm">
              <a href="#" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">{{this.title}}</a>
            </li>
          </ol>
        </nav>
        ...
        <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{{this.title}}</h1>
          </div>
    
          <!-- Options -->
          <div class="mt-4 lg:row-span-3 lg:mt-0">
            <h2 class="sr-only">Product information</h2>
            <p class="text-3xl tracking-tight text-gray-900">{{ this.price }} PLN</p>
            ...
            <form class="mt-10">
              ...
              <button @click="addToBag" type="submit" class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Add to bag</button>
            </form>
          </div>
